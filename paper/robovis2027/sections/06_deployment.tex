...
and no acoustic positioning, cannot produce. The consequence for this
paper is not subtle and we do not soften it: half of the frozen design
was never tested, the physical campaign is single-planner, and every
comparison between the two planners in this paper is simulated.
