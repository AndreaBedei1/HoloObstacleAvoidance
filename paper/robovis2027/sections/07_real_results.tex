...
\SIrange{71}{97}{\percent} of frames and avoided it in every admissible
run, never stalling: the commanded surge is zero in less than
...
on geometry, as it should not. And three of the four \textsf{K0} runs
...
\SIrange{71}{91}{\percent} of frames; their median believed range is
\SIrange{0.94}{1.51}{\metre} across runs; and between \SI{0} and
\SI{28}{\percent} of accepted frames sit exactly at the detector's
upper size gate, where the reported range saturates at
\SI{0.30}{\metre} and stops being a measurement. We report that
saturation fraction rather than a minimum range, because the minimum is
the gate and not the anchor.
