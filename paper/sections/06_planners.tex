...
success. \textbf{The frozen parameter set is Phase-8 decision D-013, which
has not been recorded at the time of writing, so the parameter table is
deliberately empty:} \PEIGHT

% TODO_PHASE8_FINAL_RESULT: insert tables/tab_dwa_parameters.tex once D-013 is
% recorded in docs/SCIENTIFIC_DECISIONS.md.  Do not transcribe development
% defaults here --- they are not the frozen configuration.
